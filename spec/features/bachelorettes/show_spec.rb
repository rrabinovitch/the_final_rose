...
RSpec.describe "When I visit a bachelorette's show page", type: :feature do
  before :each do
    ...
    @contestant_3 = @bachelorette_2.contestants.create!(name: "Another Contestant", age: 22, hometown: "Denver, CO")
  end
  ...
  it "I see the average age of all that bachelorette's contestants" do
    visit "/bachelorettes/#{@bachelorette_1.id}"
    expect(page).to have_content("Average age of contestants: 31")
  end
end
